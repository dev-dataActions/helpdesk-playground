      ...
      <div className="flex flex-col gap-y-4">
        ...
        <div className="flex items-center gap-x-2">
          {workflows.map((workflow) => (
            <div
              key={workflow.id}
              className="flex bg-white p-3 h-28 justify-center rounded-lg border border-gray-300 text-xs text-gray-800 hover:underline hover:cursor-pointer"
            >
              <a
                href={`/new_workflows/${workflow.id}`}
